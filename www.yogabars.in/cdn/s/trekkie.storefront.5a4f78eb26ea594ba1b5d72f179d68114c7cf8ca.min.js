            ...
            8680: function(e, t, n) {
                ...
                t.storefrontApiUpdateTrackingConsent = function(e, t) {
                    ...
                    return fetch(`https://${p}/api/unstable/graphql.json`, f).then((e => {
                        ...
                        return r.writeCookie(i.CONSENT_COOKIE_NAME, E, p, h), g && C && (r.writeCookie(u, E, _, g), r.writeCookie(d, E, _, C)), v !== E && (r.writeCookie(i.CONSENT_COOKIE_NAME, v, p, h), g && C && (r.writeCookie(u, v, _, g), r.writeCookie(d, v, _, C))), o.dispatchEvents(e), c.appendConsentToCustomerAccountLinks(T), void 0 !== t && t(null, a), a
                    })).catch((e => {
            ...
            3988: function(e, t, n) {
                ...
                var g = function(e) {
                    ...
                    return r(n, e), n.prototype.name = function() {
                        ...
                        h.default.isEnabled(h.SERVER_EMITTED_ADD_TO_CART_NEW_REPORTIFY_MIGRATION) ? this.produceToMonorail({
                        ...
                        return i(i({
                            ...
                            asset_version_id: "5a4f78eb26ea594ba1b5d72f179d68114c7cf8ca",
            ...
            1037: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToObserve()) {
                        var n = "5a4f78eb26ea594ba1b5d72f179d68114c7cf8ca",
                            o = null,
                            r = null,
                            i = null;
                        if (e.app_config) try {
                    ...
                    g = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "5a4f78eb26ea594ba1b5d72f179d68114c7cf8ca",
