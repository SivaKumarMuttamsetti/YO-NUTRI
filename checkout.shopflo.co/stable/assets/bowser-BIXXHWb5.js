(function() {
    try {
        var r = typeof window != "undefined" ? window : typeof global != "undefined" ? global : typeof globalThis != "undefined" ? globalThis : typeof self != "undefined" ? self : {},
            e = new r.Error().stack;
        e && (r._sentryDebugIds = r._sentryDebugIds || {}, r._sentryDebugIds[e] = "8a091c7c-0352-4ce3-9d1a-87b315e5adc2", r._sentryDebugIdIdentifier = "sentry-dbid-8a091c7c-0352-4ce3-9d1a-87b315e5adc2")
    } catch (t) {}
})();
const M = {
...
class s {
    ...
    static compareVersions(e, t, i = !1) {
        const n = s.getVersionPrecision(e),
            u = s.getVersionPrecision(t);
        let d = Math.max(n, u),
            h = 0;
        const c = s.map([e, t], b => {
            const f = d - s.getVersionPrecision(b),
                v = b + new Array(f + 1).join(".0");
            return s.map(v.split("."), m => new Array(20 - m.length).join("0") + m).reverse()
        });
        for (i && (h = d - Math.min(n, u)), d -= 1; d >= h;) {
            if (c[0][d] > c[1][d]) return 1;
            if (c[0][d] === c[1][d]) {
                if (d === h) return 0;
                d -= 1
            } else if (c[0][d] < c[1][d]) return -1
        }
    }
    static map(e, t) {
        const i = [];
    ...
    static assign(e, ...t) {
        ...
        for (n = 0, u = t.length; n < u; n += 1) {
            const d = t[n];
            typeof d == "object" && d !== null && Object.keys(d).forEach(c => {
                i[c] = d[c]
            })
        }
        return e
...
const o = /version\/(\d+(\.?_?\d+)+)/i,
    ...
    y = [{
        ...
        test: [/macintosh/i],
        describe(r) {
            const e = s.getFirstMatch(/mac os x (\d+(\.?_?\d+)+)/i, r).replace(/[_\s]/g, "."),
...
class p {
    ...
    satisfies(e) {
        ...
        if (Object.keys(e).forEach(h => {
                const c = e[h];
                typeof c == "string" ? (n[h] = c, u += 1) : typeof c == "object" && (t[h] = c, i += 1)
            }), i > 0) {
            const h = Object.keys(t),
                c = s.find(h, f => this.isOS(f));
            if (c) {
                const f = this.satisfies(t[c]);
                if (f !== void 0) return f
            }
            const b = s.find(h, f => this.isPlatform(f));
            if (b) {
                const f = this.satisfies(t[b]);
                if (f !== void 0) return f
            }
        }
        if (u > 0) {
            const h = Object.keys(n),
                c = s.find(h, b => this.isBrowser(b, !0));
    ...
    isBrowser(e, t = !1) {
        ...
        let n = e.toLowerCase();
        const u = s.getBrowserTypeByAlias(n);
        return t && u && (n = u.toLowerCase()), n === i
    }
    compareVersion(e) {
        let t = [0],
            i = e,
        ...
        if (typeof u == "string") return e[0] === ">" || e[0] === "<" ? (i = e.substr(1), e[1] === "=" ? (n = !0, i = e.substr(2)) : t = [], e[0] === ">" ? t.push(1) : t.push(-1)) : e[0] === "=" ? i = e.substr(1) : e[0] === "~" && (n = !0, i = e.substr(1)), t.indexOf(s.compareVersions(u, i, n)) > -1
    }
    isOS(e) {
...
//# sourceMappingURL=bowser-BIXXHWb5.js.map