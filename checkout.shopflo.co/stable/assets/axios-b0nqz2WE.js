...
var j = (e, t) => (t = Symbol[e]) ? t : Symbol.for("Symbol." + e),
    ut = e => {
        throw TypeError(e)
    };
var Ee = (e, t, n) => t in e ? ot(e, t, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: n
    ...
    H = (e, t) => {
        for (var n in t || (t = {})) ct.call(t, n) && Ee(e, n, t[n]);
        if (we)
            for (var n of we(t)) lt.call(t, n) && Ee(e, n, t[n]);
        return e
    },
    Re = (e, t) => it(e, at(t));
var U = (e, t, n) => new Promise((r, s) => {
        var o = f => {
                try {
                    c(n.next(f))
                } catch (l) {
    ...
    re = (e, t, n) => {
        var r = (i, c, f, l) => {
                try {
                    var u = n[i](c),
                        d = (c = u.value) instanceof L,
                        w = u.done;
                    Promise.resolve(d ? c[0] : c).then(b => d ? r(i === "return" ? i : "next", c[1] ? {
                        done: b.done,
                        value: b.value
                    } : b, f, l) : f({
                        value: b,
                        done: w
                    })).catch(b => r("throw", b, f, l))
                } catch (b) {
                    l(b)
                }
            },
            s = i => o[i] = c => new Promise((f, l) => r(i, c, f, l)),
            o = {};
        return n = n.apply(e, t), o[j("asyncIterator")] = () => o, s("next"), s("throw"), s("return"), o
    },
    se = e => {
        var t = e[j("asyncIterator")],
            n = !1,
            r, s = {};
        return t == null ? (t = e[j("iterator")](), r = o => s[o] = i => t[o](i)) : (t = t.call(e), r = o => s[o] = i => {
            ...
            return n = !0, {
                ...
                value: new L(new Promise(c => {
                    var f = t[o](i);
                    f instanceof Object || ut("Object expected"), c(f)
                }), 1)
            }
    ...
    ge = (e, t, n) => (t = e[j("asyncIterator")]) ? t.call(e) : (e = e[j("iterator")](), t = {}, n = (r, s) => (s = e[r]) && (t[r] = o => new Promise((i, c, f) => (o = s.call(e, o), f = o.done, Promise.resolve(o.value).then(l => i({
        value: l,
        done: f
    }), c)))), n("next"), n("return"), t);
(function() {
...
})(Object.create(null)), C = e => (e = e.toLowerCase(), t => Q(t) === e), Z = e => t => typeof t === e, {
    isArray: q
} = Array, z = Z("undefined");
...
function pt(e) {
    let t;
    return typeof ArrayBuffer != "undefined" && ArrayBuffer.isView ? t = ArrayBuffer.isView(e) : t = e && e.buffer && ke(e.buffer), t
}
const ht = Z("string"),
    x = Z("function"),
    je = Z("number"),
    ...
    gt = e => {
        let t;
        return e && (typeof FormData == "function" && e instanceof FormData || x(e.append) && ((t = Q(e)) === "formdata" || t === "object" && x(e.toString) && e.toString() === "[object FormData]"))
    },
    St = C("URLSearchParams"),
    [Ot, Tt, At, xt] = ["ReadableStream", "Request", "Response", "Headers"].map(C),
...
const D = typeof globalThis != "undefined" ? globalThis : typeof self != "undefined" ? self : typeof window != "undefined" ? window : global,
    Ie = e => !z(e) && e !== D;

function ce() {
    const {
        caseless: e
    } = Ie(this) && this || {}, t = {}, n = (r, s) => {
        const o = e && qe(t, s) || s;
        W(t[o]) && W(r) ? t[o] = ce(t[o], r) : W(r) ? t[o] = ce({}, r) : q(r) ? t[o] = r.slice() : t[o] = r
    };
...
const Nt = (e, t, n, {
    ...
    Dt = (e => t => e && t instanceof e)(typeof Uint8Array != "undefined" && he(Uint8Array)),
    Bt = (e, t) => {
    ...
    jt = C("HTMLFormElement"),
    qt = e => e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function(n, r, s) {
...
const Vt = e => {
    ...
    Wt = C("AsyncFunction"),
    Kt = e => e && (Y(e) || x(e)) && x(e.then) && x(e.catch),
    Me = ((e, t) => e ? setImmediate : t ? ((n, r) => (D.addEventListener("message", ({
        source: s,
        data: o
    }) => {
    ...
    }))(`axios@${Math.random()}`, []) : n => setTimeout(n))(typeof setImmediate == "function", x(D.postMessage)),
    vt = typeof queueMicrotask != "undefined" ? queueMicrotask.bind(D) : typeof process != "undefined" && process.nextTick || Me,
    a = {
        isArray: q,
        isArrayBuffer: ke,
        isBuffer: dt,
...
function ee(e, t, n) {
    ...
    const r = n.metaTokens,
        ...
        o = n.dots,
        i = n.indexes,
        f = (n.Blob || typeof Blob != "undefined" && Blob) && a.isSpecCompliantForm(t);
    ...
    function u(p, y, h) {
        ...
        if (p && !h && typeof p == "object") {
            ...
            else if (a.isArray(p) && Gt(p) || (a.isFileList(p) || a.endsWith(y, "[]")) && (E = a.toArray(p))) return y = Je(y), E.forEach(function(S, P) {
                !(a.isUndefined(S) || S === null) && t.append(i === !0 ? Oe([y], P, o) : i === null ? y : y + "[]", l(S))
            }), !1
        }
        return le(p) ? !0 : (t.append(Oe(h, y, o), l(p)), !1)
    }
    const d = [],
        w = Object.assign(Qt, {
            defaultVisitor: u,
    ...
    function b(p, y) {
        if (!a.isUndefined(p)) {
            ...
            d.push(p), a.forEach(p, function(E, g) {
                (!(a.isUndefined(E) || E === null) && s.call(t, E, a.isString(g) ? g.trim() : g, y, w)) === !0 && b(E, y ? y.concat(g) : [g])
            }), d.pop()
        }
    }
...
const Ke = {
    ...
    Yt = typeof URLSearchParams != "undefined" ? URLSearchParams : me,
    en = typeof FormData != "undefined" ? FormData : null,
    tn = typeof Blob != "undefined" ? Blob : null,
    nn = {
        isBrowser: !0,
        classes: {
            URLSearchParams: Yt,
    ...
    ye = typeof window != "undefined" && typeof document != "undefined",
    ue = typeof navigator == "object" && navigator || void 0,
    rn = ye && (!ue || ["ReactNative", "NativeScript", "NS"].indexOf(ue.product) < 0),
    sn = typeof WorkerGlobalScope != "undefined" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function",
    on = ye && window.location.href || "http://localhost",
...
const J = {
    ...
    transformRequest: [function(t, n) {
        ...
        let c;
        if (o) {
            if (r.indexOf("application/x-www-form-urlencoded") > -1) return cn(t, this.formSerializer).toString();
...
const dn = a.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
    pn = e => {
        const t = {};
        let n, r, s;
        return e && e.split(`
...
const X = (e, t, n = 3) => {
    ...
    Ne = e => (...t) => a.asap(() => e(...t)),
    gn = O.hasStandardBrowserEnv ? ((e, t) => n => (n = new URL(n, O.origin), e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(new URL(O.origin), O.navigator && /(msie|trident)/i.test(O.navigator.userAgent)) : () => !0,
...
const Pe = e => e instanceof A ? H({}, e) : e;
...
const Ze = e => {
        ...
        t.headers = i = A.from(i), t.url = We(Qe(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer), c && i.set("Authorization", "Basic " + btoa((c.username || "") + ":" + (c.password ? unescape(encodeURIComponent(c.password)) : "")));
        let f;
        if (a.isFormData(n)) {
    ...
    An = typeof XMLHttpRequest != "undefined",
    xn = An && function(e) {
        return new Promise(function(n, r) {
            ...
            }), a.isUndefined(s.withCredentials) || (h.withCredentials = !!s.withCredentials), c && c !== "json" && (h.responseType = s.responseType), l && ([w, p] = X(l, !0), h.addEventListener("progress", w)), f && h.upload && ([d, b] = X(f), h.upload.addEventListener("progress", d), h.upload.addEventListener("loadend", b)), (s.cancelToken || s.signal) && (u = S => {
    ...
    Pn = function(e, t) {
        return re(this, null, function*() {
            try {
                for (var n = ge(_n(e)), r, s, o; r = !(s = yield new L(n.next())).done; r = !1) {
                    const i = s.value;
                    yield* se(Nn(i, t))
                }
            } catch (s) {
                ...
                try {
                    r && (s = n.return) && (yield new L(s.call(n)))
                } finally {
                    if (o) throw o[0]
                }
            }
    ...
    Ye = te && typeof ReadableStream == "function",
    Fn = te && (typeof TextEncoder == "function" ? (e => t => e.encode(t))(new TextEncoder) : e => U(void 0, null, function*() {
    ...
    Fe = 64 * 1024,
    fe = Ye && et(() => a.isReadableStream(new Response("").body)),
    G = {
        stream: fe && (e => e.body)
    };
te && (e => {
...
const Ln = e => U(void 0, null, function*() {
        if (e == null) return 0;
        if (a.isBlob(e)) return e.size;
        if (a.isSpecCompliantForm(e)) return (yield new Request(O.origin, {
            method: "POST",
            body: e
        }).arrayBuffer()).byteLength;
        if (a.isArrayBufferView(e) || a.isArrayBuffer(e)) return e.byteLength;
        if (a.isURLSearchParams(e) && (e = e + ""), a.isString(e)) return (yield Fn(e)).byteLength
    }),
    Dn = (e, t) => U(void 0, null, function*() {
        const n = a.toFiniteNumber(e.getContentLength());
        return n == null ? Ln(t) : n
    }),
    Bn = te && (e => U(void 0, null, function*() {
        let {
            url: t,
            method: n,
            data: r,
        ...
        let b = Cn([s, o && o.toAbortSignal()], i),
            p;
        ...
        let h;
        try {
            if (f && Un && n !== "get" && n !== "head" && (h = yield Dn(u, r)) !== 0) {
                let T = new Request(t, {
                        method: "POST",
                        body: r,
                        duplex: "half"
                ...
                if (a.isFormData(r) && (_ = T.headers.get("content-type")) && u.setContentType(_), T.body) {
                    const [F, V] = Ce(h, X(Ne(f)));
                    r = _e(T.body, Fe, F, V)
                }
            }
            a.isString(d) || (d = d ? "include" : "omit");
            const E = "credentials" in Request.prototype;
            p = new Request(t, Re(H({}, w), {
                signal: b,
            ...
            if (fe && (c || S && y)) {
                ...
                const _ = a.toFiniteNumber(g.headers.get("content-length")),
                    [F, V] = c && Ce(_, X(Ne(c), !0)) || [];
                g = new Response(_e(g.body, Fe, F, () => {
                    V && V(), y && y()
                }), T)
            }
            l = l || "text";
            let P = yield G[a.findKey(G, l) || "text"](g, e);
            return !S && y && y(), yield new Promise((T, _) => {
                Ge(T, _, {
                    data: P,
            ...
            throw y && y(), E && E.name === "TypeError" && /fetch/i.test(E.message) ? Object.assign(new m("Network Error", m.ERR_NETWORK, e, p), {
                cause: E.cause || E
    ...
    tt = {
        getAdapter: e => {
            ...
            for (let o = 0; o < t; o++) {
                n = e[o];
                let i;
                if (r = n, !kn(n) && (r = de[(i = String(n)).toLowerCase()], r === void 0)) throw new m(`Unknown adapter '${i}'`);
                if (r) break;
                s[i || "#" + o] = r
            }
            if (!r) {
...
function Le(e) {
    return ae(e), e.headers = A.from(e.headers), e.data = ie.call(e, e.transformRequest), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), tt.getAdapter(e.adapter || J.adapter)(e).then(function(r) {
        return ae(e), r.data = ie.call(e, e.transformResponse, r), r.headers = A.from(r.headers), r
    }, function(r) {
        return Xe(r) || (ae(e), r && r.response && (r.response.data = ie.call(e, e.transformResponse, r.response), r.response.headers = A.from(r.response.headers))), Promise.reject(r)
    })
}
const nt = "1.8.4",
    ne = {};
...
ne.transitional = function(t, n, r) {
    ...
    return (o, i, c) => {
        ...
        return n && !De[i] && (De[i] = !0, console.warn(s(i, " has been deprecated since v" + n + " and will be removed in the near future"))), t ? t(o, i, c) : !0
    }
};
...
` + o) : r.stack = o
    ...
    _request(t, n) {
        ...
        if (!f) {
            ...
            for (p.unshift.apply(p, c), p.push.apply(p, l), w = p.length, u = Promise.resolve(n); d < w;) u = u.then(p[d++], p[d++]);
            return u
        }
        w = c.length;
        let b = n;
    ...
    getUri(t) {
        t = k(this.defaults, t);
        const n = Qe(t.baseURL, t.url, t.allowAbsoluteUrls);
...
//# sourceMappingURL=axios-b0nqz2WE.js.map