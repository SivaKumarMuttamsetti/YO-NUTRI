...
(function(factory) {
    ...
    var factoryOutput = (() => {
        ...
        for (let l = 0; l < C.length; l++) C[l].name = w[C[l].iso2];
        var z = 0,
            S = {
                allowDropdown: !0,
            ...
            v = l => l.replace(/\D/g, ""),
            N = (l = "") => l.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(),
            k = l => {
                let t = v(l);
                if (t.charAt(0) === "1") {
                    let e = t.substr(1, 3);
            ...
            _ = class {
                ...
                constructor(t, e = {}) {
                    this.id = z++, this.a = t, this.c = null, this.d = Object.assign({}, S, e), this.e = !!t.getAttribute("placeholder")
                }
                _init() {
                    this.d.useFullscreenPopup && (this.d.fixDropdownWidth = !1), this.d.separateDialCode && (this.d.allowDropdown = !0, this.d.nationalMode = !1), !this.d.showFlags && !this.d.separateDialCode && (this.d.nationalMode = !1), this.d.useFullscreenPopup && !this.d.dropdownContainer && (this.d.dropdownContainer = document.body), this.isAndroid = typeof navigator < "u" ? /Android/i.test(navigator.userAgent) : !1, this.isRTL = !!this.a.closest("[dir=rtl]"), this.d.i18n = { ...w,
                        ...this.d.i18n
                    };
                ...
                _f() {
                    ...
                    if (this.a.parentNode ? .insertBefore(h, this.a), t || i) {
                        this.k = p("div", {
                            class: "iti__country-container"
                        }, h), this.selectedCountry = p("button", {
                            type: "button",
                        ...
                        if (this.l = p("div", null, g), this.selectedCountryA11yText = p("span", {
                                class: "iti__a11y-text"
                            }, this.l), this.a.disabled ? this.selectedCountry.setAttribute("aria-disabled", "true") : this.selectedCountry.setAttribute("tabindex", "0"), t && (this.u = p("div", {
                                class: "iti__arrow",
                                "aria-hidden": "true"
                            }, g)), e && (this.t = p("div", {
                                class: "iti__selected-dial-code"
                            }, this.selectedCountry)), t) {
                            let m = r ? "" : "iti--flexible-dropdown-width";
                            if (this.dropdownContent = p("div", {
                                    id: `iti-${this.id}__dropdown-content`,
                                    class: `iti__dropdown-content iti__hide ${m}`
                                }), this.searchInput = p("input", {
                                    type: "text",
                                ...
                                u ? y += " iti--fullscreen-popup" : y += " iti--inline-dropdown", this.dropdown = p("div", {
                                    class: y
                                }), this.dropdown.appendChild(this.dropdownContent)
                            } else this.k.appendChild(this.dropdownContent)
                        }
                    }
                    if (h.appendChild(this.a), s) {
                        let g = this.a.getAttribute("name") || "",
                            m = s(g);
                        m.phone && (this.hiddenInput = p("input", {
                            type: "hidden",
                            name: m.phone
                        }), h.appendChild(this.hiddenInput)), m.country && (this.hiddenInputCountry = p("input", {
                            type: "hidden",
                            name: m.country
                ...
                _h(t = !1) {
                    ...
                    if (o && !r) this._v(s);
                        ...
                        let h = u ? u.toLowerCase() : "";
                        h && this._y(h, !0) ? this._z(h) : o && r ? this._z("us") : this._z()
                    }
                    s && this._u(s)
                }
                _i() {
                ...
                _i4() {
                    a.autoCountry ? this.handleAutoCountry() : a.startedLoadingAutoCountry || (a.startedLoadingAutoCountry = !0, typeof this.d.geoIpLookup == "function" && this.d.geoIpLookup((t = "") => {
                        let e = t.toLowerCase();
                        e && this._y(e, !0) ? (a.autoCountry = e, setTimeout(() => f("handleAutoCountry"))) : (this._h(!0), f("rejectAutoCountryPromise"))
                    }, () => {
                    ...
                    this._a12 = r => {
                        if (this.isAndroid && r ? .data === "+" && i) {
                            let h = this.a.selectionStart || 0,
                                ...
                                m = this.a.value.substring(h);
                            this.a.value = g + m, o();
                            return
                        }
                        this._v(this.a.value) && this._8();
                        let u = r ? .data && /[^+0-9]/.test(r.data),
                            d = r ? .inputType === "insertFromPaste" && this.a.value;
                        u || d && !t ? s = !0 : /[^+0-9]/.test(this.a.value) || (s = !1);
                        let c = r ? .detail && r.detail.isSetNumber && !n;
                        if (e && !s && !c) {
                            let h = this.a.selectionStart || 0,
                                m = this.a.value.substring(0, h).replace(/[^+0-9]/g, "").length,
                                y = r ? .inputType === "deleteContentForward",
                                b = this._9(),
                                L = F(m, b, h, y);
                            this.a.value = b, this.a.setSelectionRange(L, L)
                        }
                        ...
                        if (r.key && r.key.length === 1 && !r.altKey && !r.ctrlKey && !r.metaKey) {
                            ...
                            if (t) {
                                let u = this.a.selectionStart === 0 && r.key === "+",
                                    ...
                                    c = u || d,
                                    h = this._6(),
                                    g = a.utils.getCoreNumber(h, this.s.iso2),
                                    m = this.maxCoreNumberLength && g.length >= this.maxCoreNumberLength,
                                    y = this.a.value.substring(this.a.selectionStart, this.a.selectionEnd),
                                    b = /\d/.test(y);
                                (!c || m && !b) && r.preventDefault()
                            }
                        }
                ...
                _v(t) {
                    ...
                    if (o) {
                        let d = this.q[v(o)],
                            c = d.indexOf(this.s.iso2) !== -1 && r.length <= o.length - 1;
                        if (!(n === "1" && k(r)) && !c) {
                ...
                destroy() {
                    ...
                    e ? .parentNode ? .insertBefore(this.a, e), e ? .parentNode ? .removeChild(e), delete a.instances[this.id]
                }
                getExtension() {
