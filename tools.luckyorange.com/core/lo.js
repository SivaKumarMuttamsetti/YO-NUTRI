    ...
    var n = r(1),
        ...
        c = {
            ...
            whitelist: {
                ...
                heatmap: {
                    legacy: "".concat("https://storage.googleapis.com/lucky-orange-public", "/heatmaps2/bootstrap.js"),
                    module: !1
                },
                messenger: {
            ...
            load: async function(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                if (!c.whitelist[t]) throw new Error("Script [".concat(t, "] was not found in whitelist."));
                if (!c.loaded[t] || e.allowMultiple) {
                    var r = c.isModern() && c.whitelist[t].modern ? "modern" : "legacy",
                        n = null,
                        i = window.localStorage && window.localStorage.getItem("lo-debug-url:".concat(t)),
                        u = window.localStorage && window.localStorage.getItem("lo-debug-disable-script");
                    if (u !== t) {
                        i ? (o.log("Debug URL found for script [".concat(t, "] in localStorage.")), n = i, !1 !== c.whitelist[t].module && (e.module = !0)) : n = c.whitelist[t][r], !1 !== e.cacheControl && (n = "".concat(n, "?v=").concat("18dc3ba"));
                        var a = null;
                        e.iframe && (a = !0 !== e.iframe ? e.iframe : c.createFrame(t)), await c.waitForFrameLoad(a, (function() {
                            var r = document;
                            a && (r = a.contentDocument), e.root && (r = window.parent.document);
                            var i = c.createScript(n, {
                                name: t,
                                doc: r,
                                module: e.module
                            });
                            r && r.head && r.head.appendChild(i), o.log("Loading script from ".concat(n, " ").concat(a ? "in iframe" : "")), c.loaded[t] = !0
                        }), 10)
        ...
        parseObject: function(t) {
            ...
            if (f)
                for (r = (e = E(t, f)).next; !(n = u(r, e)).done;) {
                    if (i = (o = E(S(n.value))).next, (c = u(i, o)).done || (a = u(i, o)).done || !u(i, o).done) throw new G("Expected sequence with length 2");
                    J(s, {
                        key: j(c.value),
                        value: j(a.value)
                    })
